 ...
 */
    ...
    public void OnGameItemPlayClick(int roomId)
    {
        ...
        sfs.Send(new JoinRoomRequest(roomId, null, null));
    }
    ...
    public void OnGameItemWatchClick(int roomId)
    {
        ...
        sfs.Send(new JoinRoomRequest(roomId, null, null, true));
    }
 ...
 */
  ...
  */
   ...
   */
    ...
    {
        invitation = (Invitation)evt.Params["invitation"];
